...
const handleConfirmImport = () => {
  if (form.values.role !== 'platform-corp-user') {
    toast({
      title: 'Atenção',
      description:
        'Importação de usuários via CSV está disponível apenas para o tipo de usuário "Usuário Corporativo". Por favor, selecione este tipo de usuário para prosseguir com a importação.',
      variant: 'destructive',
    });
    return;
  } else {
    showUploadCsv.value = true;
  }
};
      ...
      <form @submit="onSubmit" @keydown.enter.prevent="true">
        <Card class="bg-zinc-200">
          ...
          <CardContent>
            ...
            <div
              v-if="showForm || form.values.role === 'master-manager'"
            ...
            >
              ...
              <div class="my-10 flex items-center gap-4">
                <div v-if="!showUploadCsv" class="flex items-center gap-4">
                  <Button type="button" @click.prevent="handleConfirmImport">
                    <Upload />
                    Importar Dados CSV
                  </Button>
